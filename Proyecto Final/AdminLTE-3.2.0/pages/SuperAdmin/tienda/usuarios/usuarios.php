                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    <thead>
                                        ...
                                        <td class="align-middle">Aff </td>
                                        <td class="align-middle">AfGBGf </td>

                                        <td class="align-middle"><a class="btn btn-warning btn-block btn-sm" >EDITAR</a></td>
                                        <td class="align-middle"><a class="btn btn-danger btn-block btn-sm" >ELIMINAR</a></td>
