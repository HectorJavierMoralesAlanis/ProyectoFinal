    ...
    <nav class="main-header navbar navbar-expand navbar-dark">
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="./dashboard.php?id=<?php echo $id?>" class="nav-link">Home</a>
            </li>
        </ul>
    </nav>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-header">Opciones</li>
                        ...
                        <li class="nav-item">
                            <a href="../tienda/usuarios/usuarios2.php?id=<?php echo $_GET['id']?>" class="nav-link">
                                <p>
                                    Usuarios
                                </p>
                            </a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="small-box bg-warning">
                                        ...
                                        <a href="./usuarios/usuarios2.php?id=<?php echo $_GET['id']?>" class="small-box-footer">
                                        Mostrar <i class="fas fa-arrow-circle-right"></i>
                                        </a>
                                    </div>
                                </div>
