                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <td class="align-middle"><a href="./editarCategorria.php?id=<?php echo $categoria['id']?>&&?tie=<?php echo $id?>" method="POST" class="btn btn-warning btn-block btn-sm" >EDITAR</a></td>
