                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <td class="align-middle"><a href="./editarCategorria.php?id=<?php echo ($categoria['tiendaId']);?>" method="POST" class="btn btn-warning btn-block btn-sm" >EDITAR</a></td>
                                        <td class="align-middle"><a href="./eliminarCategoria.php?id=<?php echo($categoria['tiendaId']); ?>" class="btn btn-danger btn-block btn-sm">ELIMINAR</a></td>
                                        </div>
                                        </td>
                                    </tr>
                                    <?php }?>
