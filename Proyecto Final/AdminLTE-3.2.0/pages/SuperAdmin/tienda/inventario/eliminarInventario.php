...
$dao2=new DAO();
$consulta2="DELETE FROM inventario WHERE id=:idU";
...
if($resultados>=0){
    ...
    header("Location: http://64.226.114.50/Proyecto%20Final/AdminLTE-3.2.0/pages/SuperAdmin/tienda/inventario/inventario.php?id=$l[tiendaId]");
    }
}else{
    echo "error";
}
